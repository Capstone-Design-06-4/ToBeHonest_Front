...
import 'messaged_item_contributed_view.dart';
import 'package:tobehonest/controllers/contributor_controller.dart';
import 'package:get/get.dart';

class MessagedItemDetailed extends StatelessWidget {
  final WishItem wishItem;

  MessagedItemDetailed({required this.wishItem});
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    SizedBox(width: 30),
                    FaIcon(FontAwesomeIcons.solidMessage, color: AppColor.swatchColor, size: 25),
                    Align(
                ...
                Padding(
                  ...
                  child: LinearPercentIndicator(
                    ...
                    progressColor: Color(0xFF463f3a),
